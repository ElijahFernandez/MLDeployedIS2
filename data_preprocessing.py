...
if __name__ == '__main__':
    ...
    input_data_path = os.path.join('C:\\Users\\Systems\\Documents\\Intelligent Systems II\\ML Model Deployment\\SMS_Spam_Classifier\\rawdata', 'EDAprocessed.csv')
    ...
    train_features_headers_output_path = os.path.join('C:\\Users\\Systems\\Documents\\Intelligent Systems II\\ML Model Deployment\\SMS_Spam_Classifier\\processed_data\\train', 'train_data_with_headers.csv')
    train_features_output_path = os.path.join('C:\\Users\\Systems\\Documents\\Intelligent Systems II\\ML Model Deployment\\SMS_Spam_Classifier\\processed_data\\train', 'train_data.csv')
    test_features_output_path = os.path.join('C:\\Users\\Systems\\Documents\\Intelligent Systems II\\ML Model Deployment\\SMS_Spam_Classifier\\processed_data\\train', 'test_data.csv')
